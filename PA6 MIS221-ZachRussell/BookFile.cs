...
namespace GUI_Practice
{
    class BookFile
    {
        public static List<Books> GetAllBooks(string cwid)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                List<Books> myBooks = releases.ToObject<List<Books>>();
        ...
        public static void SaveBook(Books myBook, string cwid, string mode)
        {
        ...
        public static void DeleteBook(Books myBook, string cwid)
        {
